...
module.exports = {
    ...
    get_conf          : `SELECT conf FROM tickets WHERE user_id=u2b(?) AND first_name=? AND last_name=? AND fare_id=u2b(?) AND birthday=?;`
}
