        ...
        return (
            <div>
                <div className={`Nav ${this.state.navOpen && 'nav-open'}`}>
                    ...
                    <div className={`extras animated ${this.state.navOpen ? 'slideInUp' : 'slideOutUp'}`}>
                        <h2 onClick={() => {this.props.optionHandler('/careers'); this.toggleNav();}}><DelayLink to='/careers'>Careers</DelayLink></h2>
                        <h2 onClick={() => {this.props.optionHandler('/contact'); this.toggleNav();}}><DelayLink to='/contact'>Contact Us</DelayLink></h2>
                        ...
                        <h2><a href="https://docs.google.com/document/d/1hXhZ9vK3IizCvQzdjiuk3PD4Lv72TYH5hMi-CLAleSc/edit?usp=sharing" target="_blank" rel="noopener noreferrer">Sources</a></h2>
                    </div>
                </div>
