                                    ...
                                    if (err) {
                                        ...
                                        req.app.locals.pool.query(query.get_token_w_email, [req.body.email], (err, result) => {
                                            ...
                                            const msg = {
                                                ...
                                                html: `<html><head><link href="https://fonts.googleapis.com/css?family=Rubik&display=swap" rel="stylesheet"><style>body{margin: 0; padding-top: 5vh; font-family: 'Rubik', 'Sans-serif'; display: flex; justify-content: center; color: white;}h1{margin-bottom: 0;}h3{margin-top: 1.5vh;}a{margin: 2vh 0 0 0; width: fit-content; padding: 2vh 2vw; background-color: white; text-decoration: none; color: #005aa7; border-radius: 0.5vw;}div{margin: 0; display: flex; flex-direction: column; align-items: center; height: 80vh; padding: 5vh 10vw; box-sizing: border-box; background-color: #005aa7; border-radius: 1vw;}</style></head><body><div><img src="https://www.westflightairlines.com/static/media/logo3.311095c9.png" alt="Logo"><h1>West Flight Airlines</h1><h3>Thank you for registering at West Flight, `+first_name+`</h3><a href="https://www.westflightairlines.com/api/user/token/`+encodeURIComponent(JSON.parse(JSON.stringify(result))[0].token)+`">Verify Account</a> <br>If you did not perform this action, please ignore this email. </div></html>`
                                            }
